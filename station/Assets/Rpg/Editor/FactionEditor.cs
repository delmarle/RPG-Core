...
namespace Station
{
  public static class FactionEditor
  {
    ...
    {
      _selectedIndex = EditorStatic.DrawGenericSelectionList(_db, _selectedIndex, _propertyScrollPos,
        out _propertyScrollPos, "bullet_yellow", false);
    }
    ...
    private static void DrawFaction(int selected)
    {
      ...
      GUILayout.Label(staticData.Name.GetValue(), EditorStatic.SectionTitle, GUILayout.Width(130));
      ...
      GUILayout.BeginHorizontal(GUILayout.ExpandWidth(true));
      {
        ...
        GUILayout.BeginVertical();
        {
          ...
          GUILayout.BeginHorizontal();
          {
            ...
            EditorStatic.DrawLocalizationLabel(staticData.Description, 45);
          }
          GUILayout.EndHorizontal();
          GUILayout.Space(3);
        }
      ...
      _selectedStance = GUILayout.SelectionGrid(_selectedStance, toolbarOptions, 1, EditorStatic.ToolBarStyle,
    ...
    private static void DrawSelected(FactionModel data)
    {
      ...
      foreach (var stanceNumber in data.Relations)
      {
        ...
        {
          GUILayout.BeginHorizontal("box");
          GUILayout.Label(_db.GetEntry(stanceNumber.Key).Name.GetValue(), GUILayout.Width(70));
