...
namespace Station
{
    ...
    public class SimpleCharacterCreation : BaseCharacterCreation
    {
        ...
        private GameSettingsModel _gameSettings = null;
        ...
        public override void Init(GameInstance station)
        {
            ...
            var gameSettingsDb = GameInstance.GetDb<GameSettingsDb>();
        ...
        public override void StartSequence()
        {
            ...
            _sceneSystem.LoadNormalScene(scene, SceneType.CharacterCreation);
